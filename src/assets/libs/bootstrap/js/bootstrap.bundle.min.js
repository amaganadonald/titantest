...
! function(t, e) { 'object' == typeof exports && 'undefined' != typeof module ? module.exports = e() : 'function' == typeof define && define.amd ? define(e) : (t = 'undefined' != typeof globalThis ? globalThis : t || self).bootstrap = e() }(this, (function() {
    ...
    class hi extends z {
        ...
        _createPopper() {
            if (void 0 === Ke) throw new TypeError('Bootstrap dropdowns require Popper (https://popper.js.org)');
            let t = this._element;
    ...
    class cn extends z {
        constructor(t, e) {
            if (void 0 === Ke) throw new TypeError('Bootstrap tooltips require Popper (https://popper.js.org)');
