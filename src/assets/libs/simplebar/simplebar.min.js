...
var SimpleBar = function() {
    ...
    function d(e) {
        return null == e ? void 0 === e ? '[object Undefined]' : '[object Null]' : u && u in Object(e) ? function(e) {
            var t = n.call(e, c),
                i = e[c];
            try { e[c] = void 0; var s = !0 } catch (e) {}
            var r = a.call(e);
    ...
    function m(e) { var t = typeof e; return null != e && ('object' == t || 'function' == t) }
    var b = /^[-+]0x[0-9a-f]+$/i,
        g = /^0b[01]+$/i,
        x = /^0o[0-7]+$/i,
        y = parseInt;
    ...
    function E(e) {
        ...
        if (function(e) { return 'symbol' == typeof e || function(e) { return null != e && 'object' == typeof e }(e) && '[object Symbol]' == d(e) }(e)) return NaN;
        if (m(e)) {
    ...
    function A(e, t, i) {
        ...
        function x() {
            var e = O(),
                i = f(e);
            if (s = arguments, r = this, a = e, i) { if (void 0 === n) return v(a); if (u) return clearTimeout(n), n = setTimeout(b, t), p(a) }
            return void 0 === n && (n = setTimeout(b, t)), o
        }
        return t = E(t) || 0, m(i) && (h = !!i.leading, l = (u = 'maxWait' in i) ? w(E(i.maxWait) || 0, t) : l, d = 'trailing' in i ? !!i.trailing : d), x.cancel = function() { void 0 !== n && clearTimeout(n), c = 0, s = a = r = n = void 0 }, x.flush = function() { return void 0 === n ? o : g(O()) }, x
    }
    var k = function() {
    ...
    t && window.addEventListener('resize', (function() { M !== window.devicePixelRatio && (M = window.devicePixelRatio, W = null) }));
    var C = function(e) {
        return Array.prototype.reduce.call(e, (function(e, t) {
            var i = t.name.match(/data-simplebar-(.+)/);
            if (i) {
                var s = i[1].replace(/\W+(.)/g, (function(e, t) { return t.toUpperCase() }));
                switch (t.value) {
                    case 'true':
                        e[s] = !0;
                        break;
    ...
    var V = Object.freeze({ __proto__: null, addClasses: T, classNamesToQuery: D, getElementDocument: z, getElementWindow: L, getOptions: C, removeClasses: R }),
        ...
        X = function() {
            function e(t, i) {
                void 0 === i && (i = {});
                var s = this;
                if (this.removePreventClickId = null, this.minScrollbarWidth = 20, this.stopScrollDelay = 175, this.isScrolling = !1, this.isMouseEntering = !1, this.scrollXTicking = !1, this.scrollYTicking = !1, this.wrapperEl = null, this.contentWrapperEl = null, this.contentEl = null, this.offsetEl = null, this.maskEl = null, this.placeholderEl = null, this.heightAutoObserverWrapperEl = null, this.heightAutoObserverEl = null, this.rtlHelpers = null, this.scrollbarWidth = 0, this.resizeObserver = null, this.mutationObserver = null, this.elStyles = null, this.isRtl = null, this.mouseX = 0, this.mouseY = 0, this.onMouseMove = function() { console.log(); }, this.onWindowResize = function() { console.log }, this.onStopScrolling = function() { console.log(); }, this.onMouseEntered = function() { console.log; }, this.onScroll = function() {
                        var e = H(s.el);
                        ...
                        var t = j(s.el),
                            i = H(s.el);
                        e.preventDefault(), e.stopPropagation(), q(s.el, s.classNames.dragging), t.removeEventListener('mousemove', s.drag, !0), t.removeEventListener('mouseup', s.onEndDrag, !0), s.removePreventClickId = i.setTimeout((function() { t.removeEventListener('click', s.preventClick, !0), t.removeEventListener('dblclick', s.preventClick, !0), s.removePreventClickId = null }))
            ...
            return e.getRtlHelpers = function() {
            ...
            }, e.prototype.getScrollbarWidth = function() { try { return this.contentWrapperEl && 'none' === getComputedStyle(this.contentWrapperEl, '::-webkit-scrollbar').display || 'scrollbarWidth' in document.documentElement.style || '-ms-overflow-style' in document.documentElement.style ? 0 : N() } catch (e) { return N() } }, e.getOffset = function(e) {
                var t = e.getBoundingClientRect(),
                    i = j(e),
                    s = H(e);
                return { top: t.top + (s.pageYOffset || i.documentElement.scrollTop), left: t.left + (s.pageXOffset || i.documentElement.scrollLeft) }
            }, e.prototype.init = function() { t && (this.initDOM(), this.rtlHelpers = e.getRtlHelpers(), this.scrollbarWidth = this.getScrollbarWidth(), this.recalculate(), this.initListeners()) }, e.prototype.initDOM = function() {
                var e, t;
                ...
                if (this.el.addEventListener('mouseenter', this.onMouseEnter), this.el.addEventListener('pointerdown', this.onPointerEvent, !0), this.el.addEventListener('mousemove', this.onMouseMove), this.el.addEventListener('mouseleave', this.onMouseLeave), null === (e = this.contentWrapperEl) || void 0 === e || e.addEventListener('scroll', this.onScroll), i.addEventListener('resize', this.onWindowResize), this.contentEl) {
                    ...
                    this.mutationObserver = new i.MutationObserver((function() { i.requestAnimationFrame((function() { t.recalculate() })) })), this.mutationObserver.observe(this.contentEl, { childList: !0, subtree: !0, characterData: !0 })
                }
            ...
            }, e.prototype.onMouseLeaveForAxis = function(e) { void 0 === e && (e = 'y'), q(this.axis[e].track.el, this.classNames.hover), q(this.axis[e].scrollbar.el, this.classNames.hover), this.options.autoHide && this.hideScrollbar(e) }, e.prototype.onDragStart = function(e, t) {
                var i;
                void 0 === t && (t = 'y');
                var s = j(this.el),
                    r = H(this.el),
        ...
        I = Y.addClasses,
        $ = function(t) {
            function i() { for (var e = [], s = 0; s < arguments.length; s++) e[s] = arguments[s]; var r = t.apply(this, e) || this; return i.instances.set(e[0], r), r }
            return function(t, i) {
                if ('function' != typeof i && null !== i) throw new TypeError('Class extends value ' + String(i) + ' is not a constructor or null');

                function s() { this.constructor = t }
                e(t, i), t.prototype = null === i ? Object.create(i) : (s.prototype = i.prototype, new s)
            }(i, t), i.initDOMLoadedElements = function() { document.removeEventListener('DOMContentLoaded', this.initDOMLoadedElements), window.removeEventListener('load', this.initDOMLoadedElements), Array.prototype.forEach.call(document.querySelectorAll('[data-simplebar]'), (function(e) { 'init' === e.getAttribute('data-simplebar') || i.instances.has(e) || new i(e, F(e.attributes)) })) }, i.removeObserver = function() {
                var e;
                null === (e = i.globalObserver) || void 0 === e || e.disconnect()
            }, i.prototype.initDOM = function() {
                var e, t, i, s = this;
                if (!Array.prototype.filter.call(this.el.children, (function(e) { return e.classList.contains(s.classNames.wrapper) })).length) {
