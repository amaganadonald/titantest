<template>
  <div style="overflow: hidden">
    ...
    <div class="row g-3">
      <div class="col-12 col-sm-6" v-for="(tab, index) in tabInfo" :key="index">
        <div v-if="index == 0" class="form-group row">
          <label :for="tab.vModel" class="col-sm-2 col-form-label">{{
            $t(tab.vModel)
          }}</label>
          <div v-if="$props.operation != 'add'" class="col-sm-8">
            <input
              disabled
              type="text"
              class="form-control"
