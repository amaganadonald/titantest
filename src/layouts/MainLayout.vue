          ...
          <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="dropdown ms-sm-3 header-item topbar-user">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <!-- item-->
                  <h6 class="dropdown-header">Welcome {{ usr }}!</h6>
                  ...
                  >
                  <router-link to="/taskbar" class="dropdown-item"
                    ><i
                  ...
                  >
                  <router-link to="/fags" class="dropdown-item"
                    ><i
                  ...
                  <router-link to="/utilisateur" class="dropdown-item"
                    ><i
        ...
        <div id="scrollbar">
          <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <div class="collapse menu-dropdown" id="sidebarDashboards">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item" v-if="menu.includes('parcMateriels')">
                      <router-link to="/parcMateriels" class="nav-link">{{
                        $t('parcMateriels')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('typeVeh')">
                      <router-link to="/typeVeh" class="nav-link">{{
                        $t('typeVeh')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('famVeh')">
                      <router-link to="/famVeh" class="nav-link">{{
                        $t('famVeh')
                      }}</router-link>
                    </li>
                    <li v-if="menu.includes('activiteVeh')">
                      <router-link to="/activiteVeh" class="nav-link">{{
                        $t('activiteVeh')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('affectationVeh')">
                      <router-link to="/affectationVeh" class="nav-link">{{
                        $t('affectationVeh')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('siteVeh')">
                      <router-link to="/siteVeh" class="nav-link">{{
                        $t('siteVeh')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('groupVeh')">
                      <router-link to="/groupVeh" class="nav-link">{{
                        $t('groupVeh')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('carburant')">
                      <router-link to="/carburant" class="nav-link">{{
                        $t('carburantType')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('typeInt')">
                      <router-link to="/typeInt" class="nav-link">{{
                        $t('typeInt')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('marques')">
                      <router-link to="/marques" class="nav-link">{{
                        $t('marques')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('fournisseur')">
              ...
              <!-- end Dashboard Menu -->
              <li class="nav-item" v-if="menu.includes('database')">
                <a
                  class="nav-link menu-link"
                  href="#sidebarApps"
                ...
                >
                  ...
                  <span data-key="t-apps">{{ $t('database') }}</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarApps">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item" v-if="menu.includes('consommation')">
                      <router-link to="/consommation" class="nav-link">{{
                        $t('consommation')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('horaire')">
                      <router-link to="/horaire" class="nav-link">{{
                        $t('horaire')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('kilometrage')">
                      <router-link to="/kilometrage" class="nav-link">{{
                        $t('kilometrage')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('tonnage')">
                      <router-link to="/tonnage" class="nav-link">{{
                        $t('tonnage')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('pneumatique')">
                      <router-link to="/pneumatique" class="nav-link">{{
                        $t('pneumatique')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('lubrifiants')">
                      <router-link to="/lubrifiants" class="nav-link">{{
                        $t('lubrifiants')
                      }}</router-link>
                    </li>
                  </ul>
              ...
              <li class="menu-title">
                ...
                <span data-key="t-pages">Maintenance</span>
              </li>

              <li class="nav-item" v-if="menu.includes('panne')">
                <a
                  class="nav-link menu-link"
                  href="#sidebarAuth"
                  data-bs-toggle="collapse"
                ...
                >
                  ...
                  <span data-key="t-authentication">{{ $t('panne') }}</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarAuth">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item" v-if="menu.includes('fichepanne')">
                      <router-link to="/fichepanne" class="nav-link">{{
                        $t('fichepanne')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('pannes')">
                      <router-link to="/pannes" class="nav-link">{{
                        $t('pannes')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('intervention')">
                      <router-link to="/intervention" class="nav-link">{{
                        $t('intervention')
                      }}</router-link>
                    </li>
                  </ul>
              ...
              <li class="nav-item" v-if="menu.includes('historique')">
                <a
                  class="nav-link menu-link"
                  href="#sidebarPages"
                  data-bs-toggle="collapse"
                ...
                >
                  ...
                  <span data-key="t-pages">{{ $t('historique') }}</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarPages">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item" v-if="menu.includes('bonNonLivre')">
                      <router-link to="/bonNonLivre" class="nav-link">{{
                        $t('bonNonLivre')
                      }}</router-link>
                    </li>
                    <li
                      class="nav-item"
                      v-if="menu.includes('histoIntervention')"
                    >
                      <router-link to="/histoIntervention" class="nav-link">{{
                        $t('histoIntervention')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('entretien')">
                      <router-link to="/entretien" class="nav-link">{{
                        $t('entretien')
                      }}</router-link>
                    </li>
                  </ul>
              ...
              <li class="menu-title">
                <i class="ri-more-fill"></i>
                <span data-key="t-components">Reporting</span>
              </li>

              <li class="nav-item" v-if="menu.includes('graphes')">
                <a
                  class="nav-link menu-link"
                  href="#sidebarUI"
                  data-bs-toggle="collapse"
                ...
                >
                  ...
                  <span data-key="t-base-ui">{{ $t('graphes') }}</span>
                </a>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <ul class="nav nav-sm flex-column">
                        <li
                          class="nav-item"
                          v-if="menu.includes('grapheactivite')"
                        >
                          <router-link to="/grapheactivite" class="nav-link">{{
                            $t('grapheactivite')
                          }}</router-link>
                        </li>
                        <li
                          class="nav-item"
                          v-if="menu.includes('grapheconso')"
                        >
                          <router-link to="/grapheconso" class="nav-link">{{
                            $t('grapheconso')
                          }}</router-link>
                        </li>
                        <li
                          class="nav-item"
                          v-if="menu.includes('graphefficience')"
                        >
                          <router-link to="/graphefficience" class="nav-link">{{
                            $t('graphefficience')
                          }}</router-link>
                        </li>
                        <li
              ...
              <li class="nav-item" v-if="menu.includes('rapports')">
                <a
                  class="nav-link menu-link"
                ...
                >
                  ...
                  <span data-key="t-advance-ui">{{ $t('rapports') }}</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarAdvanceUI">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item" v-if="menu.includes('rapcons')">
                      <router-link to="/rapcons" class="nav-link">{{
                        $t('rapcons')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('rapeff')">
                      <router-link to="/rapeff" class="nav-link">{{
                        $t('rapeff')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('rapinterv')">
                      <router-link to="/rapinterv" class="nav-link">{{
                        $t('rapinterv')
                      }}</router-link>
                    </li>
                    <li
                      class="nav-item"
                      v-if="menu.includes('TransportCannes')"
                    >
                      <router-link to="/TransportCannes" class="nav-link">{{
                        $t('TransportCannes')
                      }}</router-link>
                    </li>
                    <li
                      class="nav-item"
                      v-if="menu.includes('activiteHoraire')"
                    >
                      <router-link to="/activiteHoraire" class="nav-link">{{
                        $t('activiteHoraire')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('raphoraire')">
                      <router-link to="/raphoraire" class="nav-link">{{
                        $t('raphoraire')
                      }}</router-link>
                    </li>
                  </ul>
              ...
              <li class="nav-item" v-if="menu.includes('import')">
                <a
                  class="nav-link menu-link"
                  href="#sidebarForms"
                  data-bs-toggle="collapse"
                ...
                >
                  ...
                  <span data-key="t-forms">{{ $t('import') }}</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarForms">
                  <ul class="nav nav-sm flex-column">
                    ...
                    <li
                      class="nav-item"
                      v-if="menu.includes('importDataTransport')"
                    >
                      <router-link to="/importDataTransport" class="nav-link">{{
                        $t('importDataTransport')
                      }}</router-link>
                    </li>
                  </ul>
                </div>
              ...
              <li class="nav-item" v-if="menu.includes('admin')">
                <a
                  class="nav-link menu-link"
                  href="#sidebarTables"
                  data-bs-toggle="collapse"
                ...
                >
                  ...
                  <span data-key="t-tables">{{ $t('admin') }}</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarTables">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item" v-if="menu.includes('fonction')">
                      <router-link to="/fonction" class="nav-link">{{
                        $t('fonction')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('departement')">
                      <router-link to="/departement" class="nav-link">{{
                        $t('departement')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('atelier')">
                      <router-link to="/atelier" class="nav-link">{{
                        $t('atelier')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('personnel')">
                      <router-link to="/personnel" class="nav-link">{{
                        $t('personnel')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('utilisateur')">
                      <router-link to="/utilisateur" class="nav-link">{{
                        $t('utilisateur')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('profil')">
                      <router-link to="/profil" class="nav-link">{{
                        $t('profil')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('typeDocument')">
                      <router-link to="/typeDocuments" class="nav-link">{{
                        $t('typeDocument')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('autorisation')">
                      <router-link to="/autorisation" class="nav-link">{{
                        $t('autorisation')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('menu')">
                      <router-link to="/menu" class="nav-link">{{
                        $t('menu')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('connex')">
                      <router-link to="/connex" class="nav-link">{{
                        $t('connex')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('eventSensible')">
                      <router-link to="/eventSensible" class="nav-link">{{
                        $t('eventSensible')
                      }}</router-link>
                    </li>
                    <li class="nav-item" v-if="menu.includes('svgDb')">
                      <router-link to="/svgDb" class="nav-link">{{
                        $t('svgDb')
                      }}</router-link>
                    </li>
                  </ul>
...
div .app-menu::-webkit-scrollbar-track{
-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);
border-radius: 10px;
background-color: #F5F5F5;
}
div .app-menu::-webkit-scrollbar{
width: 5px;
height: 10px;
background-color: #F5F5F5;
}
div .app-menu::-webkit-scrollbar-thumb{
border-radius: 10px;
-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);
