<template>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title-->
            <TableData :header="header" :data="data" title="Activités" tb="activiteVeh" @refreshTable="refreshTable" cbTable="mnDts"/>
      ...
      export default defineComponent({
        ...
        setup() {
            ...
            const header = [
               ...
               { text: 'Libelle', value: 'activite_name', sortable: true, width: 150, type: 'string'},
