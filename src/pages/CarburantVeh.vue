<template>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Type de Carburant</h4>
            ...
            <!-- end page title-->
            <TableData :header="header" :data="data" title="Carburant" tb="carburant" @refreshTable="refreshTable" cbTable="mnDts"/>
    ...
    <script lang="ts">
      ...
      export default defineComponent({
        ...
        setup() {
            ...
            let data = computed(()=>store.carburant)
            const header = [
