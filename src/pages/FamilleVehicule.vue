<template>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page -->
            <TableData  :header="header" :data="data" title="Famille_vehicules" tb="fam_veh" @refreshTable="refreshTable" cbTable="mnDts"/>
      ...
      export default defineComponent({
        ...
        setup() {
          ...
          const header = [
            ...
            { text: 'Code', value: 'id_fam', sortable: true, width: 200, type: 'string'},
            { text: 'Libelle', value: 'lib_fam', sortable: true, width: 200, type: 'string'},
            { text: 'Creation', value: 'datej', sortable: true, width: 100, type: 'date'},
            ...
            { text: 'Action', value: 'operation', sortable: true, width: 100, type: 'action'},
          ]
          const refreshTable = ()=>{
            store.allFamVeh();
          }
