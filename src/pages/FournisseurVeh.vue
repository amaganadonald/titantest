<template>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title-->
            <TableData :header="header" :data="data" title="fournisseur" tb="fournisseur" @refreshTable="refreshTable" cbTable="mnDts"/>
      ...
      export default defineComponent({
        ...
        setup() {
            ...
            const header = [
               ...
               { text: 'Description', value: 'description', sortable: true, width: 60, type: 'string'},
