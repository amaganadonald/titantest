<template>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title-->
            <TableData :header="header" :data="data" title="MarqueVeh" tb="marque" @refreshTable="refreshTable" cbTable="mnDts"/>
      ...
      export default defineComponent({
        ...
        setup() {
            ...
            const header = [
               ...
               { text: 'Image', value: 'image', sortable: true, width: 40, type: 'image'},
               // { text: 'Code', value: 'code', sortable: true, width: 150, type: 'string'},
               { text: 'Libelle', value: 'libelle', sortable: true, width: 150, type: 'string'},
               { text: 'Description', value: 'description', sortable: true, width: 300, type: 'string'},
               { text: 'Date', value: 'datej', sortable: true, width: 200, type: 'date'},
