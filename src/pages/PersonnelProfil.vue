            ...
            <div class="row g-4">
                ...
                <div class="col">
                    <div class="p-2">
                        ...
                        <p class="text-white-75" v-if="pers.fonction != null">{{pers.fonction.libelle}}</p>
                        <div class="hstack text-white-50 gap-1">
                            <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i>{{pers.matricule}}</div>
                            <!--div>
                                <i class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>{{pers.matricule}}
                            </div-->
                        </div>
                    </div>
                </div>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{pers.nom}}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Mobile :</th>
                                                            <td class="text-muted">{{pers.tel}}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">E-mail :</th>
                                                            <td class="text-muted">{{pers.email}}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Location :</th>
                                                            <td class="text-muted">{{pers.adresse}}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">cni</th>
                                                            <td class="text-muted">{{pers.cni}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(){
        ...
        const pers = computed(()=>store.personne)
        let matricule = ref()
        onMounted(()=>{
            console.log(router.currentRoute.value.params.id)
            matricule.value = router.currentRoute.value.params.id
            store.personnelByMatricule(matricule.value)
