      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            ...
            >
              <h4 class="mb-sm-0">PNEUMATIQUE</h4>
              ...
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item active">Pneumatique</li>
                </ol>
              </div>
            </div>
          </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    let data = computed(() => store.dataPneumatique);
    const importFile = async () => {
      loading.value = true;
      console.log(datab.value);
      await store.uploadPneumatique(datab.value);
      $q.notify({
    ...
    onMounted(async () => {
      await store.allDataPneumatique();
    });
    return {
      fichier,
      importFile,
