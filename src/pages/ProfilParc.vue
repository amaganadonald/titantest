<template>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title-->
            <TableData :header="header" :data="data" title="profil" tb="profil" @refreshTable="refreshTable" cbTable="mnDts"/>
      ...
      export default defineComponent({
        ...
        setup() {
            ...
            const header = [
               ...
               { text: 'Libelle', value: 'name', sortable: true, width: 200, type: 'string'},
               { text: 'Description', value: 'description', sortable: true, width: 200, type: 'string'},
               { text: 'Menus', value: 'menu', sortable: true, width: 200, type: 'object'},
               { text: 'Autorisation', value: 'autorisation', sortable: true, width: 150, type: 'object'},
