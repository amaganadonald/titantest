            ...
            >
              ...
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item active">Tonnage</li>
                </ol>
              </div>
            </div>
          </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    let data = computed(() => store.dataTonnage);
    const importFile = async () => {
      loading.value = true;
      console.log(datab.value);
      await store.uploadTonnage(datab.value);
      $q.notify({
    ...
    const header = [
      ...
      {
        text: 'Distance moyenne pondérée',
        value: 'dmp',
        sortable: true,
        type: 'string',
        title: 'Distance moyenne pondérée',
        dataKey: 'dmp',
      },
      {
        text: 'Date',
