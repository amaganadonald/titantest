...
<div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
    <div class="row g-4">
        <div class="col-auto">
            <div class="avatar-lg">
                <img :src="ig" alt="user-img" class="img-thumbnail rounded-circle" />
            </div>
        </div>
        <!--end col-->
        <div class="col">
            <div class="p-2">
                <h3 class="text-white mb-1">{{user.nom}} {{  user.prenom }}</h3>
                <p class="text-white-75" v-if="user.profil!=null"><i class="mdi mdi-account-cog me-1 text-white-75 fs-16 align-middle"></i>{{user.profil.name}}</p>
                <div class="hstack text-white-50 gap-1">
                    <div class="me-2"><i class="mdi mdi-badge-account-horizontal-outline me-1 text-white-75 fs-16 align-middle"></i>{{user.adresse}}</div>
                    <div>
                        <i class="mdi mdi-phone me-1 text-white-75 fs-16 align-middle"></i>{{user.tel}}
                    </div>
                </div>
            </div>
        </div>
      <q-dialog v-model="seamless" position="right" seamless transition-show="fade" transition-hide="slide-down">
        <q-card style="width: 600px; max-width: 90vw;">
          <q-card-section>
            <!--ManageDataVue :head="headers" :data="opeData" :operation="operation" :title="titre" :tbname="$props.tb" @closeModal="closeModal"/-->
            test
          </q-card-section>
        </q-card>
      </q-dialog>
        ...
        <div>
            <div class="d-flex">
                ...
                <div class="flex-shrink-0">
                  <button @click="editItem(user)" type="button" class="btn btn-success" >
                ...
                <div class="tab-pane active" id="overview-tab" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="progress animated-progress custom-progress progress-label">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: 30%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">
                                        ...
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-muted">{{user.nom}}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-muted">{{user.adresse}}
                                                    </td>
                                                </tr>
                                                <tr>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">Menus</h5>
                                    <div class="d-flex flex-wrap gap-2 fs-15" v-if="user.profil!=null">
                                      <router-link v-for="men in user.profil.menus" :key="men.id"  :to="'/${men.name}'" class="badge badge-soft-secondary">{{$t(men.name) }}</router-link>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="flex-grow-1">
                                            <h5 class="card-title mb-0">Autorisations</h5>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <div class="dropdown">
                                    ...
                                    <div v-if="user.profil!=null">
                                        <div class="d-flex align-items-center py-2">
                                            <div class="avatar-xs flex-shrink-0 me-2" >
                                              <q-chip v-if="user.profil.autorisation.cp===true" dense  color="teal" text-color="white"><i class="fa-solid fa-circle-check img-fluid rounded-circle"></i></q-chip>
                                              <q-chip v-else dense  color="red" text-color="white"><i class="fa-sharp fa-solid fa-xmark img-fluid rounded-circle"></i></q-chip>
                                            </div>
                                            <div class="flex-grow-1">
                                                <div>
                                                    <h5 class="fs-14 mb-1">COPY</h5>
                                                    <p class="fs-13 text-muted mb-0">Copie des données</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center py-2">
                                            <div class="avatar-xs flex-shrink-0 me-2">
                                              <q-chip v-if="user.profil.autorisation.ad===true" dense  color="teal" text-color="white"><i class="fa-solid fa-circle-check img-fluid rounded-circle"></i></q-chip>
                                              <q-chip v-else dense  color="red" text-color="white"><i class="fa-sharp fa-solid fa-xmark img-fluid rounded-circle"></i></q-chip>
                                            </div>
                                            <div class="flex-grow-1">
                                                <div>
                                                    <h5 class="fs-14 mb-1">ADD</h5>
                                                    <p class="fs-13 text-muted mb-0">Ajouter données</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center py-2">
                                            <div class="avatar-xs flex-shrink-0 me-2">
                                              <q-chip v-if="user.profil.autorisation.del===true" dense  color="teal" text-color="white"><i class="fa-solid fa-circle-check img-fluid rounded-circle"></i></q-chip>
                                              <q-chip v-else dense  color="red" text-color="white"><i class="fa-sharp fa-solid fa-xmark img-fluid rounded-circle"></i></q-chip>
                                            </div>
                                            <div class="flex-grow-1">
                                                <div>
                                                    <h5 class="fs-14 mb-1">DELETE</h5>
                                                    <p class="fs-13 text-muted mb-0">Supprimer données</p>
                                                </div>
                                            </div>
                                        </div>
                                      <div class="d-flex align-items-center py-2">
                                        <div class="avatar-xs flex-shrink-0 me-2" >
                                          <q-chip v-if="user.profil.autorisation.up===true" dense  color="teal" text-color="white"><i class="fa-solid fa-circle-check img-fluid rounded-circle"></i></q-chip>
                                          <q-chip v-else dense  color="red" text-color="white"><i class="fa-sharp fa-solid fa-xmark img-fluid rounded-circle"></i></q-chip>
                                        </div>
                                        <div class="flex-grow-1">
                                          <div>
                                            <h5 class="fs-14 mb-1">UPDATE</h5>
                                            <p class="fs-13 text-muted mb-0">Mise à jour des données</p>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="d-flex align-items-center py-2">
                                        <div class="avatar-xs flex-shrink-0 me-2" >
                                          <q-chip v-if="user.profil.autorisation.upl===true" dense  color="teal" text-color="white"><i class="fa-solid fa-circle-check img-fluid rounded-circle"></i></q-chip>
                                          <q-chip v-else dense  color="red" text-color="white"><i class="fa-sharp fa-solid fa-xmark img-fluid rounded-circle"></i></q-chip>
                                        </div>
                                        <div class="flex-grow-1">
                                          <div>
                                            <h5 class="fs-14 mb-1">UPLOAD</h5>
                                            <p class="fs-13 text-muted mb-0">importer des données</p>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
...
<script lang="ts">
  ...
  setup(){
    ...
    const getImageUrl = (img:any) => {
        console.log(img)
        if (img!=null) {
          return new URL(`http://localhost:4000/images/user/${img}`, import.meta.url)
        }
      }
    let matricule = ref()
    ...
    onMounted(async ()=>{
        ...
        matricule.value = router.currentRoute.value.params.id
        await store.utilisateurById(matricule.value)
        ig.value = getImageUrl(user.value.url_photo)
